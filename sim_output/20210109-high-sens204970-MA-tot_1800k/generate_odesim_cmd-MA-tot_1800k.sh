...
script="./run_vac_strategies-MA-sens_20_49_70.sh"
    ...
    do
        ...
        do
            ...
            do
                ...
                outdir="s${startday:0:3}_e${endday:((${#endday}-3)):3}_d${dpd:0:5}_i${nat_imm}_c${normalcyday}_u${vac_duration}_t${vac_halflife}_p${vac_slope}"
                if [ -d "$outdir" ]; then
                    rm $outdir/*
                else
                    mkdir $outdir
