...
def Generate_Beta_List(partial_beta_list, first_beta_daynum, final_beta_daynum, 
    ...
    if first_beta_daynum + len_pbl + buffer_ndays - 1 < sin_origin_daynum:
...
if __name__ == "__main__":
    # %%
    out_dir = Path(Path.home(), 'Code/covid19-vaccine/sim_output/beta/MA-20210107/')

    loc = "MA"
    # b = pd.read_csv(Path(Path.home(), 'Code/covid19/inference/output/RI/20201215-v6/400k+/RI-1215-nonorm_extra_dec06-sampling_100.daily.betas-day-341.csv'))
    # p = pd.read_csv(Path(Path.home(), 'Code/covid19/inference/output/RI/20201215-v6/400k+/RI-1215-nonorm_extra_dec06-sampling_100.ode.params-day-341.csv'))
    # s = pd.read_csv(Path(Path.home(), 'Code/covid19/inference/output/RI/20201215-v6/400k+/RI-1215-nonorm_extra_dec06-sampling_100.spline.coeff.betas-day-341.csv'))
    b = pd.read_csv(Path(Path.home(), 'Code/covid19/inference/output/MA/2020_12_15_Thu-v6/400k+/MA-1215-nonorm_extra_dec06S-sampling_100.daily.betas-day-341.csv'))
    p = pd.read_csv(Path(Path.home(), 'Code/covid19/inference/output/MA/2020_12_15_Thu-v6/400k+/MA-1215-nonorm_extra_dec06S-sampling_100.ode.params-day-341.csv'))
    s = pd.read_csv(Path(Path.home(), 'Code/covid19/inference/output/MA/2020_12_15_Thu-v6/400k+/MA-1215-nonorm_extra_dec06S-sampling_100.spline.coeff.betas-day-341.csv'))
    ...
    fig.tight_layout()
    fig.savefig( Path(out_dir, '{}-low-beta_0p{}-rm{}-{}-zoom.png'.format(loc, int(trough_peak_ratio*10), rm, 'median' if sample_id is None else 'sampleid_'+str(sample_id)) ) )
