...
void generate_trajectories( double inital_number_of_cases, double param_beta, double t0, double tf, double h )
{
    ...
    {                                       // but we do anyway because tt is just barely below ttstop by some tiny fraction
        ...
        if( !bContactRatesUpdatedAfterLockdown && tt > G_CLO_FIRSTLOCKDOWN_ENDDAY )
        {
            ...
            if (ppc->cm_loc == (int)(contact_matrix_loc::be) || ppc->cm_loc == (int)(contact_matrix_loc::ukbe)){
                ...
                G_C_COMM[4][8] = 0.001;                G_C_COMM[8][4] = 0.6;
        ...
        if( !b_normalcy_contact_rates_updated && tt > G_CLO_NORMALCY_BEGINDAY )
        {
            if (ppc->cm_loc == (int)(contact_matrix_loc::be)){
                ...
                // POLYMOD - UK matrix from `socialmixr` R package;
                G_C_COMM[0][0] = 5.1522843;
                G_C_COMM[0][1] = 1.248731;              G_C_COMM[1][0] = 1.2318841;
                G_C_COMM[0][2] = 1.0964467;             G_C_COMM[2][0] = 1.2711864;
                G_C_COMM[0][3] = 2.0203046;             G_C_COMM[3][0] = 1.9384615;
                G_C_COMM[0][4] = 1.203046;              G_C_COMM[4][0] = 0.7863248;
                G_C_COMM[0][5] = 0.6091371;             G_C_COMM[5][0] = 0.5583333;
                G_C_COMM[0][6] = 0.3604061;             G_C_COMM[6][0] = 0.7096774;
                G_C_COMM[0][7] = 0.1218274;             G_C_COMM[7][0] = 0.2758621;
                G_C_COMM[0][8] = 0.02030457;            G_C_COMM[8][0] = 0.2758621;

                G_C_COMM[1][1] = 8.0628019; 
                G_C_COMM[1][2] = 1.173913;              G_C_COMM[2][1] = 1.440678;
                G_C_COMM[1][3] = 1.7294686;             G_C_COMM[3][1] = 1.1230769;
                G_C_COMM[1][4] = 1.710145;              G_C_COMM[4][1] = 1.8547009;
                G_C_COMM[1][5] = 0.7004831;             G_C_COMM[5][1] = 0.8916667;
                G_C_COMM[1][6] = 0.3719807;             G_C_COMM[6][1] = 0.5913978;
                G_C_COMM[1][7] = 0.1304348;             G_C_COMM[7][1] = 1.0;
                G_C_COMM[1][8] = 0.02415459;            G_C_COMM[8][1] = 1.0;

                G_C_COMM[2][2] = 3.6016949;
                G_C_COMM[2][3] = 1.8898305;             G_C_COMM[3][2] = 1.5153846;
                G_C_COMM[2][4] = 1.754237;              G_C_COMM[4][2] = 1.6153846;
                G_C_COMM[2][5] = 1.1016949;             G_C_COMM[5][2] = 1.6333333;
                G_C_COMM[2][6] = 0.4661017;             G_C_COMM[6][2] = 1.172043;
                G_C_COMM[2][7] = 0.1525424;             G_C_COMM[7][2] = 0.6896552;
                G_C_COMM[2][8] = 0.05084746;            G_C_COMM[8][2] = 0.6896552;

                G_C_COMM[3][3] = 2.7615385;
                G_C_COMM[3][4] = 1.730769;              G_C_COMM[4][3] = 2.1794872;
                G_C_COMM[3][5] = 1.2076923;             G_C_COMM[5][3] = 1.55;
                G_C_COMM[3][6] = 0.6153846;             G_C_COMM[6][3] = 1.7204301;
                G_C_COMM[3][7] = 0.2384615;             G_C_COMM[7][3] = 0.4482759;
                G_C_COMM[3][8] = 0.05384615;            G_C_COMM[8][3] = 0.4482759;

                G_C_COMM[4][4] = 2.897436;
                G_C_COMM[4][5] = 1.3504274;             G_C_COMM[5][4] = 1.483333;
                G_C_COMM[4][6] = 0.6837607;             G_C_COMM[6][4] = 1.505376;
                G_C_COMM[4][7] = 0.4017094;             G_C_COMM[7][4] = 1.413793;
                G_C_COMM[4][8] = 0.1965812;             G_C_COMM[8][4] = 1.413793;

                G_C_COMM[5][5] = 1.8583333;
                G_C_COMM[5][6] = 0.8166667;             G_C_COMM[6][5] = 1.4301075;
                G_C_COMM[5][7] = 0.3416667;             G_C_COMM[7][5] = 0.9310345;
                G_C_COMM[5][8] = 0.29166667;            G_C_COMM[8][5] = 0.9310345;
                
                G_C_COMM[6][6] = 1.172043;
                G_C_COMM[6][7] = 0.344086;              G_C_COMM[7][6] = 1.2068966;
                G_C_COMM[6][8] = 0.20430108;            G_C_COMM[8][6] = 1.2068966;

                G_C_COMM[7][7] = 1.1034483;
                G_C_COMM[7][8] = 0.24137931;            G_C_COMM[8][7] = 1.1034483;

                G_C_COMM[8][8] = 0.24137931;
            }
