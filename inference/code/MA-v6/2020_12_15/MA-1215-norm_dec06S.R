...
prms <- c(2.98466975, 1.66697384, 2.78710498, 2.98897991, 2.93848828, 
          2.50814796, 2.18943372, 3.51016304, 7.06588704, 
          2.99751066, 4.21860558, 2.12767885, 2.03011459, 1.30059982,
          1.91276616, 1.63580840, 1.82317953, 4.12416655,
          140.56241110,
          0.16960106944475, 1.23339266404366, 0.90358315382231, 0.67908984289885, 0.42149355512183, 
          0.811160038752403, 0.722492493989609, 0.727217892834893, 0.35722847919527,
          240)
...
names(prms) <- c("contact-coeff-00","contact-coeff-10","contact-coeff-20","contact-coeff-30","contact-coeff-40",
                 ...
                 "contact-coeff-norm-00","contact-coeff-norm-10","contact-coeff-norm-20","contact-coeff-norm-30","contact-coeff-norm-40",
                 "contact-coeff-norm-50","contact-coeff-norm-60","contact-coeff-norm-70","contact-coeff-norm-80",
                 "normalcy-beginday")
...
const.prms.start=c(2, "",
                   ...
                   0.11060653, 0.34329851, 0.84262255, 0.78035244, 7.19868338)
names(const.prms.start) = c("steps-per-day", "symp-frac-davies", 
                            ...
                            "death-prob-home-70", "death-prob-home-80", "dev-ventdeath-mid", "prob-icu-vent","mean-time-vent")
