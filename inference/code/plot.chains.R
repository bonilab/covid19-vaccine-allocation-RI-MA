...
ncol.plots = 5
pdf.plot = TRUE
pdf.name = "RI_sf-e4_chains.pdf"

plot.chains = function(out.folder,nrow.plots=3,ncol.plots=5,pdf.plot=TRUE,pdf.name="chains.pdf"){
  ##
  ## Function to plot mcmc chains to determine good place for burnin
  ##
