...
### initialize figure 5 plot

ri.beta = "../../final_outputs_for_ms/pre-print/RI/RI_bestfit-results.daily.betas-day-250.csv"
...
ma.beta = "../../final_outputs_for_ms/pre-print/MA/MA-20201014-sep06S.daily.betas-day-250.csv"
ma.ode = "../../final_outputs_for_ms/pre-print/MA/MA-20201014-sep06S.ode.params-day-250.csv"
...
fig5panel <- function(ri.beta, ri.ode, ri.data, ri.const,
  ...
  if (logplot){
    ...
    plot(y = 1:8 + 0.1, x = ri.hfrac.sum[,1], ylim = c(0.5, 8.5), xlim = c(0,0.35),
         xlab = "",
         ylab = "", main = "", col = addTrans(ri.color, 250),
         pch = 16, bty = "l", yaxt = "n", cex = 1.25,
         cex.axis = axis.size, cex.lab = lab.size)
...
paramSummary(beta.directory, ode.directory, data.directory, odepath, 
             loc, const, file.name, subsample = NA){
...
fig2panel(beta.directory = "../../final_outputs_for_ms/pre-print/RI/RI_bestfit-results.daily.betas-day-250.csv", 
          ...
          odepath = "../../cpp-v5-discharges-nonhospdeaths/", 
          loc = "RI", const = const.vec.ri, 
          plot.name = "../../final_outputs_for_ms/pre-print/RI/RI-ms-figure2.png", alpha = 50, 
          png.true = T,
          subsample = 250, 
          axis.size = 1.75, lab.size = 1.75,
          ncol = 2, nrow = 4, height = 12, width = 12,
...
# set.seed(55)
# 
# fig5panel(beta.directory = "./RI_bestfit-results.daily.betas-day-250.csv",
#           ode.directory = "./RI_bestfit-results.ode.params-day-250.csv",
#           data.directory = "../../data/Rhode_Island/RI_formatted_20200906.csv",
#           odepath = "../../cpp-v5-discharges-nonhospdeaths/",
#           loc = "RI",
#           const = const.vec.ri,
#           plot.name = "RI-ms-figure5.pdf",
#           alpha = 25, subsample = 250,
#           axis.size = 1.75, lab.size = 1.75,
#           height = 12, width = 6, font.family = "Ubuntu Mono")
...
fig2panel(beta.directory = "../../final_outputs_for_ms/pre-print/MA/MA-20201014-sep06S.daily.betas-day-250.csv",
          ode.directory = "../../final_outputs_for_ms/pre-print/MA/MA-20201014-sep06S.ode.params-day-250.csv",
...
fig4(beta.directory = "../../final_outputs_for_ms/pre-print/MA/MA-20201014-sep06S.daily.betas-day-250.csv",
     ode.directory = "../../final_outputs_for_ms/pre-print/MA/MA-20201014-sep06S.ode.params-day-250.csv",
     data.directory = "../../data/Massachusetts/Past_data/MA_20200906_data_7daysmoothed.csv",
     odepath = "../../cpp-v5-discharges-nonhospdeaths/",
     loc = "MA", const = const.vec.ma, 
