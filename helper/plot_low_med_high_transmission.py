...
if __name__ == "__main__":
    ...
    # out_dir_1 = Path(cpp_dir.parent, 'sim_output/20210111-low-allvac-{}-tot_1800k'.format(loc))
    # out_dir_2 = Path(cpp_dir.parent, 'sim_output/20210111-med-allvac-{}-tot_1800k'.format(loc))
    # out_dir_3 = Path(cpp_dir.parent, 'sim_output/20210111-high-allvac-{}-tot_1800k'.format(loc))    
